// CREDITS
// https://sdngeeks.wordpress.com/2014/08/01/network-statistics-sample-sdn-application-with-opendaylight-code-walk-thru/
...
function getNetworkDeviceDiv(name, id, mac, upTime) {
    var div = '<div class="col-sm-6 col-md-4"><div class="thumbnail"><br /> <br /> <img src="img/device.png"><divtion">';
    div += '<h4>' + name + '</h4>';
